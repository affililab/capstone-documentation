...
4. [Backend](https://github.com/affililab/affililab-backend) (Backend of Application) - written in Typescript
5. [Backend Library](https://github.com/affililab/affililab-ms-library) - written in Typescript
6. Crawler for partnerprograms - written in Typescript
    - [100partnerprogramme-crawler](https://github.com/affililab/hunder_partnerprograms-crawler)
7. [Recommendation System](https://github.com/affililab/recommendation-system) - written in Python
